...
public class PAYBILLS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ENTER BILL TYPE");

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("ENTER BILL NUMBER");

        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("ENTER REGISTRED EMAIL");

        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("ENTER WALLET PASSWORD");
        ...
        jLabel6.setText("ENTER BILL AMOUNT");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(t2)
                            .addComponent(t1)
                            .addComponent(t5, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "Select * from sin where email=? and pass=?";
           ...
           ResultSet rs=ps.executeQuery();
            if(rs.next()){
      PreparedStatement ps1=con.prepareStatement("insert into trance(billname,billno,uid) values(?,?,?)");
                ps1.setString(1, t1.getText());
                ps1.setString(2, t2.getText());
                ps1.setInt(3,rs.getInt(1));
                ps1.executeUpdate();
     PreparedStatement ps2=con.prepareStatement("update trance set tdate=now() where uid=?");
                ps2.setInt(1,rs.getInt(1));
                ps2.executeUpdate();
   PreparedStatement ps3=con.prepareStatement("update sin set balance=balance-? where uid=? ");
                ps3.setInt(1, Integer.parseInt(t5.getText()));
